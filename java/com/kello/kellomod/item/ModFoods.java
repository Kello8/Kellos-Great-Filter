...
public class ModFoods {
    ...
    public static final FoodProperties AMETHYST_CARROT = (new FoodProperties.Builder()).nutrition(7).saturationMod(15).effect(new MobEffectInstance(MobEffects.REGENERATION, 100, 1), 0.05F).build();
    public static final FoodProperties AMETHYST_BEEF = (new FoodProperties.Builder()).nutrition(12).saturationMod(4).effect(new MobEffectInstance(MobEffects.REGENERATION, 20, 4), 0.02F).build();
    ...
    public static final FoodProperties AMETHYST_ROTTEN_FLESH = (new FoodProperties.Builder()).nutrition(7).saturationMod(0.5F).effect(new MobEffectInstance(MobEffects.HUNGER, 120, 0), 0.6F).build();
    public static final FoodProperties AMETHYST_SWEET_BERRIES = (new FoodProperties.Builder()).nutrition(5).saturationMod(1).effect(new MobEffectInstance(MobEffects.REGENERATION, 20, 4), 0.01F).build();
    public static final FoodProperties AMETHYST_COOKIE = (new FoodProperties.Builder()).nutrition(3).saturationMod(1).effect(new MobEffectInstance(MobEffects.REGENERATION, 20, 4), 0.01F).build();
    public static final FoodProperties AMETHYST_RABBIT = (new FoodProperties.Builder()).nutrition(6).saturationMod(2).effect(new MobEffectInstance(MobEffects.REGENERATION, 20, 4), 0.01F).build();
    public static final FoodProperties AMETHYST_POISONOUS_POTATO = (new FoodProperties.Builder()).nutrition(1).saturationMod(0).effect(new MobEffectInstance(MobEffects.POISON, 100, 4), 0.6F).build();
    public static final FoodProperties AMETHYST_MELON_SLICE = (new FoodProperties.Builder()).nutrition(2).saturationMod(0).effect(new MobEffectInstance(MobEffects.REGENERATION, 20, 4), 0.01F).build();
}